import type { IPostgreSQLConnectionService } from '~/services/database-service';
import type { Adapter, AdapterAccount, AdapterSession, AdapterUser, VerificationToken } from '@auth/core/adapters';

import { and, eq } from 'drizzle-orm';

import { accountsTable, sessionsTable, usersTable, verificationTokensTable } from '~/services/schema';
